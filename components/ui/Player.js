...
export default function Player() {
  ...
  const isMainPage = ['/dashboard', '/songs', '/profile', '/payments', '/invite', '/pricing', '/create'].includes(router.pathname)
  ...
  return (
    <div className="player-pill" style={{
      position: 'fixed', 
      bottom: isMainPage ? 'calc(env(safe-area-inset-bottom, 0px) + 115px)' : '20px',
      left: 0, right: 0,
      margin: '0 auto',
      width: 'calc(100% - 24px)',
      maxWidth: 500,
